  ...
  <section>
    ...
    <section id="grid">
      <section class="info">
        ...
        <p>
          Heatstroke occurs when the body fails to regulate its own temperature
          and body temperature continues to rise, often to 40°C (104°F) or
          higher. Signs of rapidly progressing heatstroke include:
        </p>
      ...
      <section class="steps">
        ...
        <div class="step-grid">
          ...
          <p>
            ...
            hydration. You may have to help.
          </p>
        </div>
      </section>
    </section>
    <section class="video">
      <iframe
        width="560"
        height="315"
        src="https://www.youtube.com/embed/jvGC_dQJUtE"
        frameborder="0"
